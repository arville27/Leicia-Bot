...
//         let results = [];
//         try {
//             results = await searchLyrics(terms, [Provider.LN, Provider.GENIUS, Provider.AL]);
//         } catch (error) {
//             return await reply(interaction, embedResponse({ msg: `${error}`, color: '#eb0000' }));
//         }
...
//         selectMenu(client, interaction, row, onCollect, false);
//     },
// };
